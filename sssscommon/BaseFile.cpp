...
uint8_t *BaseFile::GetOffsetPtr(const void *base, uint32_t *offsets_table, uint32_t idx, bool native) const
{
	if (native)
...
const char *BaseFile::FindString(const char *list, const char *str, unsigned int num_str)
{
	...
	DPRINTF("Iiiiiiiiiiiiiiincoming crash.\n");	
