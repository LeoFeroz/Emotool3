...
::
:: This bat file generates "Hyoga with clothes, with leg armor from first armor"
::
...
::
:: The base here is Hyoga with robes.
set base="DHY_00"
...
::
:: The other here is Hyoga with first armor.
set other="HYG_00"
...
::
:: Just a name.
set result="HYOGA_ROBES_LEG_ARMOR"
...
::
:: In this case, we don't want the lower part of the body of Hyoga with clothes 
set parts_to_remove="SHARE_leg,EDGE_SHARE_leg,PARTS_shoes,EDGE_PARTS_shoes"

:: These are the parts of "other" that we want in the final model.
::
:: We want the lower body part of Hyoga with armor.
set parts_to_add="SHARE_leg,EDGE_SHARE_leg,CLOTH_leg,EDGE_CLOTH_leg"
...
::
:: We don't want all of these added. They are mostly guesses, not exact "scientific" method.
:: Basically, the most important you consider a bone, the more likely you should put it here, but
:: it is not always like that, it is... complicated.
set bones_to_not_add="Waist,LKnee,RKnee,LHip,RHip,LLegDir,RLegDir"
...
::
:: We don't need this for this mod.
...
::
:: Nah, we don't want nothing here.
